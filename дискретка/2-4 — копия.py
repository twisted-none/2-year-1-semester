...
def main():
    ...
    # Вычисление средней длины кода Шеннона-Фано
    avg_length_sf = processor.calculate_average_code_length(shannon_fano.codes, processor.char_frequencies)
    
    print("Коды Шеннона-Фано:", shannon_fano.codes)
    print(f"Закодированный текст: {encoded_sf}")
    print(f"Декодированный текст: {decoded_sf}")
    print(f"Средняя длина кода: {avg_length_sf:.2f} бит/символ")
    print(f"Разница между энтропией и средней длиной кода: {(avg_length_sf - entropy):.2f} бит/символ")
    ...
    # Вычисление средней длины кода Хаффмана
    avg_length_huff = processor.calculate_average_code_length(huffman.codes, processor.char_frequencies)
    
    print("Коды Хаффмана:", huffman.codes)
    print(f"Закодированный текст: {encoded_huff}")
    print(f"Декодированный текст: {decoded_huff}")
    print(f"Средняя длина кода: {avg_length_huff:.2f} бит/символ")
    print(f"Разница между энтропией и средней длиной кода: {(avg_length_huff - entropy):.2f} бит/символ")
